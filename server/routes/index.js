...
router.post('/office/:uId/declare', Validation.uIdQueryParameter, Verification.isLoggedIn, User.declareInterest);
router.patch('/office/:uId/register', Validation.uIdQueryParameter, Verification.isAdmin, User.registerCandidate);
